...
// Ќе включаем эту возможность поскольку большинство прерываний с высоким приоритем используют сервис RTOS дл€ передачи флагов
//#define __NVIC_PRIO_BITS                        4
//#define TX_PORT_USE_BASEPRI
//#define TX_PORT_BASEPRI                         (14 << (8 - __NVIC_PRIO_BITS))  // ћаска приоритета в регистре BASEPRI запрещающа€ прерывани€ PendSV и  SysTick
