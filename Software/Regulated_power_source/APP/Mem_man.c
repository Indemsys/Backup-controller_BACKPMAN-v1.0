...
__root void * __stack_start    @ "STACK_START";
...
/*-----------------------------------------------------------------------------------------------------
  ...
  \return uint32_t
-----------------------------------------------------------------------------------------------------*/
uint32_t App_create_pool_memry(void)
{
  g_app_pool_memory = (uint8_t *)&__free_ram_start;
  g_app_pool_size   = (uint32_t)&__stack_start - (uint32_t)g_app_pool_memory + 1;
