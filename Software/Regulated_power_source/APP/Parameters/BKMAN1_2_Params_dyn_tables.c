...
// ќбъ€вление таблицы параметров
// ƒемонстрационна€ реализаци€
...
{
  { BKMAN1_2_General,  TYPE_MISC_TABLE , "Misc table"  , MISC_TABLE_REC_NUM  },
};
...
/*-----------------------------------------------------------------------------------------------------
  ѕолучение указател€ на таблицу с перечислением свойств полей таблицы параметров и колическтва полей в таблице параметров
...
/*-----------------------------------------------------------------------------------------------------
  ѕолучение количества записей в таблице параметров
...
/*-----------------------------------------------------------------------------------------------------
   ѕолучение указател€ на запись в таблице по индексу записи
