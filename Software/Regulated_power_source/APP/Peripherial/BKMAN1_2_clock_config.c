 ...
 ******************************************************************************/
const scg_sosc_config_t clock_config =
{
  ...
  .div2        = kSCG_AsyncClkDivBy64,         /* System OSC Clock Divider 2: divided by 64 */
...
void BOARD_BootClockRUN(void)
{
  ...
  CLOCK_InitSysOsc(&clock_config);
  /* Set the XTAL0 frequency based on board settings. */
  CLOCK_SetXtal0Freq(clock_config.freq);
